...
- [ ] Entering names must be have max length of 100
- [ ] Entering recipe names must be have max length of 255
- [ ] Change activity level into table and remove the hardcoded mapping.
- [ ] The script to generate test data must be updated to generate data into the database instead of YAML files.
- [ ] "Do you want to save the recipe 'Skyr' to disk? (Y/n)" must be renamed.
