...
- [ ] Implement the selection part
  - [x] Extract the new search as a feature assistant
  - [x] Cleanup the assistant code from old search code
  - [x] Add the assistant to the menu
  - [ ] Use the old search code to implement the nutrition search
  - [ ] Change the search method to use the new vector + FTS search 
...
- [ ] Add Links to the database IDs and call the search function for this link.
...
| Decision                               | Cause                                                                                          |
| -------------------------------------- | ---------------------------------------------------------------------------------------------- |
| I implement an assistant and a search. | The assistant is a new feature. The search is used to find nutritional information in the app. |
